...
Setup: Asks for your username and starts an interactive loop menu.

Length Validation: Prompts for the password length ensuring it stays within the minimum of 12 and maximum of 126 characters.

Customization: Asks the user whether to include numbers, symbols, and/or uppercase letters in the available character pool.
